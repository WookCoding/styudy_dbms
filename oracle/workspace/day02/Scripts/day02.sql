...
ALTER TABLE TBL_PET DROP CONSTRAINT PK_PET;
ALTER TABLE TBL_PET ADD CONSTRAINT PK_PET PRIMARY KEY(PET_ID);
...
INSERT INTO TBL_POT
(POT_ID, POT_COLOR, POT_SHAPE, FLOWER_NAME, FLOWER_COLOR)
VALUES(2, '노란색', '벽돌집', '장미', '빨간색');

INSERT INTO TBL_POT
(POT_ID, POT_COLOR, POT_SHAPE, FLOWER_NAME, FLOWER_COLOR)
VALUES(3, '초록색', '원기둥', '장미', '노란색');
...
/*
	...
	│OWNER_PHONE	 : VARCHAR2 NOT NULL UK_OWNER_PHONE		│
	│OWNER_AGE	 : NUMBER									│
	│_______________________________________________________│
*/
CREATE TABLE TBL_OWNER(
	OWNER_ID NUMBER CONSTRAINT PK_OWNER PRIMARY KEY,
	OWNER_NAME VARCHAR2(1000) CONSTRAINT REQUIER_NAMES NOT NULL,
	OWNER_ADDRESS VARCHAR2(1000) CONSTRAINT REQUIER_ADDRESS NOT NULL,
	OWNER_AGE NUMBER CONSTRAINT REQUIER_AGES NOT NULL,
	OWNER_PHONE VARCHAR2(1000) CONSTRAINT REQUIER_PHONE NOT NULL,
	CONSTRAINT UK_OWNER_PHONE UNIQUE(OWNER_PHONE)
);
...
/*
	...
	│PET_TYPE : NUMBER FK_FLOWER_ID  	│
	│OWNER_ID : NUMBER FK_OWNER_ID		│
...
CREATE TABLE TBL_PET(
	...
	PET_DISEASE VARCHAR2(1000) CONSTRAINT REQUIER_PET_DISEASE NOT NULL,
	OWNER_ID NUMBER,
...
ALTER TABLE TBL_PET ADD(PET_AGE NUMBER);
ALTER TABLE TBL_PET MODIFY PET_AGE CONSTRAINT REQUIER_PET_AGE NOT NULL;

ALTER TABLE TBL_OWNER DROP(OWNER_PHONE);
ALTER TABLE TBL_OWNER ADD(OWNER_PHONE VARCHAR2(1000));
ALTER TABLE TBL_OWNER ADD CONSTRAINT UK_OWNER_PHONE UNIQUE(OWNER_PHONE);
...
(OWNER_ID, OWNER_NAME, OWNER_ADDRESS, OWNER_AGE, OWNER_PHONE)
VALUES(SEQ_OWNER.NEXTVAL, '한동석', '경기도 남양주시', 20, '01012341234');
...
/*반려동물 추가 : 동일한 보호자로 지정*/
INSERT INTO TBL_PET
(PET_ID, PET_NAME, PET_TYPE, PET_DISEASE, OWNER_ID, PET_AGE)
VALUES(SEQ_PET.NEXTVAL, '뽀삐', '강아지', '감기', 1 , 3);

INSERT INTO TBL_PET
(PET_ID, PET_NAME, PET_TYPE, PET_DISEASE, OWNER_ID, PET_AGE)
VALUES(SEQ_PET.NEXTVAL, '삐뽀', '고양이', '골절', 1 , 2);

INSERT INTO TBL_PET
(PET_ID, PET_NAME, PET_TYPE, PET_DISEASE, OWNER_ID, PET_AGE)
VALUES(SEQ_PET.NEXTVAL, '쥐', '햄토리', '장염', 2 , 4);
